...
static const int64 nTargetTimespan = 3 * 60 * 60; // TestCoin: every 3 hours
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1387898298;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1523tt18;
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // TestCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
