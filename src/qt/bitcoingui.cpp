...
void BitcoinGUI::createActions()
{
    ...
    //chat box
    TestCoin = new QAction(QIcon(":/icons/export"), tr("&TestCoin..."), this);
    TestCoin->setToolTip(tr("TestCoin"));
    TestCoin->setCheckable(true);
    tabGroup->addAction(TestCoin);
    ...
    connect(TestCoin, SIGNAL(triggered()), this, SLOT(showHome()));
...
void BitcoinGUI::setMining(bool mining, int hashrate)
{
    if (mining)
    {
        ...
        labelMiningIcon->setToolTip(tr("Dig TestCoins at %1 hashes per second").arg(hashrate));
    }
    else
    {
        labelMiningIcon->setPixmap(QIcon(":/icons/mining_inactive").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
        labelMiningIcon->setToolTip(tr("Not dig TestCoins"));
    }
}
