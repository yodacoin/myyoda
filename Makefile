...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sun Dec 22 14:38:33 2013
# Project:  billioncoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe USE_UPNP:=1 -o Makefile billioncoin-qt.pro
#############################################################################
...
Makefile: billioncoin-qt.pro  ../Qt/4.8.4/mkspecs/win32-g++/qmake.conf ../Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP:=1 -o Makefile billioncoin-qt.pro
